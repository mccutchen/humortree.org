...
<html>
<head>
	<title>Color Fade© - (Alternate Version 2) - A Humor Tree™ Brand Technology</title>
    ...
    function fade(which)
		{
			...
			{
				var newR = Math.floor(startColors[which][0] * ((step-countArray[which])/step) + endColors[0] * (countArray[which]/step));
				var newG = Math.floor(startColors[which][1] * ((step-countArray[which])/step) + endColors[1] * (countArray[which]/step));
				var newB = Math.floor(startColors[which][2] * ((step-countArray[which])/step) + endColors[2] * (countArray[which]/step));
				setbgColor(newR, newG, newB, which);
				countArray[which]++;
